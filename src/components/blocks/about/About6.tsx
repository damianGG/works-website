    ...
    <div className="container pt-5 pt-md-5 pb-13 pb-md-15 mb-n14 mb-md-n17" style={{ maxWidth: "56rem" }} data-bs-theme='dark'>
      ...
      <div className="row gx-lg-8 gx-xl-12 gy-10 mb-5  align-items-center ">
        ...
        <div className="col-lg-12">
          ...
          <h2 className="display-4 mb-3 text-center mb-10"></h2>

          <p className="lead fs-lg">
            Work & Training Service to lider w dziedzinie szkoleń i doradztwa, specjalizujący się w aktywizacji zawodowej oraz rozwijaniu umiejętności pracowników i klientów indywidualnych. Dzięki naszej wiedzy i doświadczeniu pomagamy osiągać sukces zawodowy na każdym etapie kariery.
          </p>
        </div>
      </div>
      ...
      <div className="row gx-lg-8 gx-xl-12 gy-10 mb-14  align-items-center ">
        ...
        <div className="col-lg-12">
          ...
          <div className="row gy-3 ">
            ...
            <p className="mt-10">Zaufaj sprawdzonej firmie i dołącz do grona naszych zadowolonych Klientów!
              Zapraszamy do współpracy i wspólnego rozwoju!</p>
          </div>
